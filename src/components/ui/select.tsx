...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'text-[0.8125rem] font-medium font-display text-text',
      'transition-all duration-fast ease-out-expo',
      'hover:border-border-active hover:bg-surface-elevated',
      'focus:outline-none focus:border-accent-primary focus:ring-[3px] focus:ring-accent-glow',
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-text-secondary opacity-70" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('py-1.5 pl-8 pr-2 text-[0.6875rem] font-semibold text-text-secondary', className)}
    {...props}
  />
))
